...
df = pd.read_excel('/Users/juan/Library/CloudStorage/GoogleDrive-juan.sanz@asociacionbigdata.com/Unidades compartidas/Máster UMH/II TÉCNICAS ESTADÍSTICAS PARA EL APRENDIZAJE/temario/Parte 1/Ejemplos-20240926/regresion.xlsx')
...
X = np.array(X)
Y = np.array(Y)
# Agregamos la columna de 1s (unos) a X para el intercepto
