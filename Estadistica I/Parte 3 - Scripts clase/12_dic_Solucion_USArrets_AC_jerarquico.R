...
fviz_dend(hc1, cex = 0.8, lwd = 0.8, k = 4,
          ...
          rect = TRUE, 
          rect_border = "gray", 
          rect_fill = FALSE, type= "circular")

fviz_dend(hc5, cex = 0.8, lwd = 0.8, k = 4,
          k_colors = c("red", "green3", "blue", "magenta"),
          rect = TRUE, 
          rect_border = "gray", 
          rect_fill = FALSE, type= "phylogenic")
...
# El coeficiente de partición Dunn normalizado y sin normalizar. 
# Valores normalizados próximos 
